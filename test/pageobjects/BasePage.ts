...
// await el1.click();
// const el2 = await driver.$("id:com.android.permissioncontroller:id/permission_allow_one_time_button");
// await el2.click();
// const el3 = await driver.$("id:com.android.permissioncontroller:id/permission_allow_button");
// await el3.click();
// const el4 = await driver.$("accessibility id:Continue");
// await el4.click();
// const el5 = await driver.$("accessibility id:I have read and agree");
// await el5.click();
// const el6 = await driver.$("accessibility id:I have read and agree");
// await el6.click();
// const el7 = await driver.$("accessibility id:Menu");
// await el7.click();
// const el8 = await driver.$("-android uiautomator:new UiSelector().text(\"login\")");
// await el8.click();
// const el9 = await driver.$("-android uiautomator:new UiSelector().text(\"Email\")");
// await el9.addValue("marciorocha@mail.drop.cc");
// const el10 = await driver.$("-android uiautomator:new UiSelector().text(\"Password\")");
// await el10.addValue("Maje1425");
// const el11 = await driver.$("accessibility id:Sign in");
// await el11.click();
// const el12 = await driver.$("-android uiautomator:new UiSelector().text(\"Back\")");
// await el12.click();
// const el13 = await driver.$("accessibility id:Categorias");
// await el13.click();
// const el14 = await driver.$("accessibility id:Roupas");
// await el14.click();
// const el15 = await driver.$("-android uiautomator:new UiSelector().text(\"Camisas\")");
// await el15.click();
